...
$JAVA -server $JAVA_OPTS $JAVA_OPTS_SCRIPT -Dlog4j.configuration="file:$LOG_FILE" -Dmoquette.path="$MOQUETTE_PATH" -cp "$MOQUETTE_HOME:$MOQUETTE_HOME/libs/*" com.fennechome.server.FennecMqttEntryPoint
